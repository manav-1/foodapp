...
export default function RestrauntSignUpLogin({ navigation }) {
  ...
  useEffect(() => {
    const loginBtn = document.getElementById("login-restraunt");
    const signupBtn = document.getElementById("signup-restraunt");
  ...
  return (
    <div className="form-container-restraunt">
      <button className="btn-back" onClick={() => navigation.goBack()}>
        <img src={back} alt="back"></img>
      </button>
      <Helmet>
        <title>Restraunt SignUp</title>
      </Helmet>
      <div className="form-structor">
        <div className="signup">
          <h2 className="form-title" id="signup-restraunt">
            <span>or</span>Sign up as Restraunt
          </h2>
        ...
        <div className="login slide-up">
          <div className="center">
            <h2 className="form-title" id="login-restraunt">
              <span>or</span>Log in as Restraunt
            </h2>
            <div className="form-holder">
              <input
                value={loginEmail}
